#!/bin/bash
# Sync
telegram -M "OrangeFox 9.0 (R10.1) - J7 (j7xelte): Sync started"
SYNC_START=$(date +"%s")
...
telegram -M "OrangeFox 9.0 (R10.1) - J7 (j7xelte): Sync completed successfully in $((SYNC_DIFF / 60)) minute(s) and $((SYNC_DIFF % 60)) seconds"
